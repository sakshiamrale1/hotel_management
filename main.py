...
Label(sroot,text="Sakshi Amrale",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
Label(sroot,text="sakshiamrale1@gmail.com",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
...
def mainroot():
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by Sakshi',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Mr. SHRADDHESH SHELKANDE",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		Label(emp1inf,text="Ms. Pratiksha Kamathe",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		...
		Label(emp1inf,text="Mr. Prathmesh Amrutkar (Head)",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		...
		Label(emp1inf,text="Ms. Gayatri Desai (Head)",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
